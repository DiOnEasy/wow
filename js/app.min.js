...
const relaxSwiper = new Swiper('.relax__slider', {
slidesPerView: "auto",
freeMode: false,
grabCursor: true,
autoplay: {
...
$('div.relax__column').each(function() {
let divHeight = this.getBoundingClientRect().width;
$(this).width(divHeight);
});
$(".relax__slider").hover(function() {
...
(this).swiper.autoplay.start();
	...
	$('.ask__question').on('click', function(e){
		e.preventDefault();
		var item = $(this).closest('.faq-item');
		item.find('.ask-answer').slideToggle(200);
	})
